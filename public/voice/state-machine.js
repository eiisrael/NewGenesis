...
const transitions = Object.freeze({
  IDLE: ['LISTENING', 'TRANSCRIBING', 'THINKING', 'PREPARING', 'SPEAKING', 'ERROR'],
  ...
  THINKING: ['PREPARING', 'SPEAKING', 'LISTENING', 'IDLE', 'ERROR'],
  PREPARING: ['SPEAKING', 'THINKING', 'LISTENING', 'INTERRUPTING', 'IDLE', 'ERROR'],
  SPEAKING: ['PREPARING', 'INTERRUPTING', 'LISTENING', 'THINKING', 'IDLE', 'ERROR'],
